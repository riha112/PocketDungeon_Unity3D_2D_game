...
namespace Assets.Scripts.Items.Type.Controller.Weapons
{
    ...
    {
        public override ItemType[] Resolves() => new[] { ItemType.WeaponBow };
        ...
        protected GameObject Projectile
        {
            get
            {
                ...
                {
                    _projectile = Info.Prefabs.Length > 1 ? Info.Prefabs[2] : Resources.Load<GameObject>($"Prefabs/Items/Weapons/Projectiles/{PATH_TO_DEFAULT_PROJECTILE}");
                }
                return _projectile;
            }
        }
